...
public class FragmentINIC extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        procesar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                new PostInicialAsyncTask().execute();
            }
        });
    ...
    private class PostInicialAsyncTask extends AsyncTask<Carga, Void, Boolean> {
        @Override
    ...
    private void crearCarga(Carga carga) {
        ...
        if (carga == null) {
            ...
            carga.setTipo(Globales.getInstancia().getTipos().get(0));
